...
```
В БД меню уже добавлены все адреса кроме одного. Этот адрес предлагается добавить вручную для демонстрации процесса добавления:

### Самостоятельное добавление в БД
