    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Укажите адресс меню', max_length=200, unique=True, verbose_name='Адресс меню')),
            ],
        ),
        migrations.CreateModel(
            name='Section',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Укажите человекочитаемое имя секции меню.', max_length=200, unique=True, verbose_name='Название')),
                ('adress', models.SlugField(help_text='Укажите адресс секции без /', max_length=200, unique=True, verbose_name='Адресс секции')),
